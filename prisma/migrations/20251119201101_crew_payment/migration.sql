...
INSERT INTO "new_CrewPaymentRequest" ("address", "amount", "appointmentId", "attachmentsJson", "createdAt", "crewUserId", "customerName", "extrasJson", "extrasTotal", "grandTotal", "id", "installTotal", "pastJobId", "ratePerSquare", "rateTier", "tenantId", "usedSquares") SELECT "address", "amount", "appointmentId", "attachmentsJson", "createdAt", "crewUserId", "customerName", "extrasJson", "extrasTotal", "grandTotal", "id", "installTotal", "pastJobId", "ratePerSquare", "rateTier", "tenantId", "usedSquares" FROM "CrewPaymentRequest";
